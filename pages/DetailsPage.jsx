...
// VetAssistantIcon and health status icons have been removed
...
const DetailsPage = () => {
    ...
    // The veterinary helper functions have been removed.
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div className="mb-6 flex justify-between items-center">
                     ...
                     <button
                         onClick={handleShare}
                         disabled={isSharing}
                         className="inline-flex items-center justify-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm text-white bg-emerald-600 hover:bg-emerald-700 disabled:bg-emerald-400"
                     >
                ...
                <div ref={reportRef} className="bg-stone-50 p-4 sm:p-8 rounded-lg">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-5 gap-8">
                        ...
                        <div className="lg:col-span-3 space-y-8">
                           <InfoCard title="PashuDrishti AI: Detailed Breed Analysis" icon={<BreedDetectorIcon />}>
                                <p><strong>Primary Breed :</strong> <span className="font-bold text-emerald-700">{advanced_breed_detector.primary_breed}</span></p>
                                <p><strong>Confidence Score :</strong> <span className="font-semibold">{(advanced_breed_detector.confidence_score * 100).toFixed(1)}%</span></p>
                                
                                {yoloData && yoloData.length > 0 && (
                                    <p className="text-sm text-stone-600 pt-2 border-t mt-2">
                                        <strong>Initial Detection (Local Model):</strong> {yoloData[0].breed} at {Math.round(yoloData[0].confidence * 100)}% confidence.
                                    </p>
                                )}
                            ...
                            {/* The AI Veterinary Assistant InfoCard has been completely removed */}
